...
export class SymbolNodesApi extends runtime.BaseAPI {
     ...
     */
    async getSymbolApiNodesRaw(requestParameters: GetSymbolApiNodesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Node>>> {
     ...
     * Returns the list of known API-only Symbol nodes.
     */
    async getSymbolApiNodes(requestParameters: GetSymbolApiNodesRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Node>> {
     ...
     */
    async getSymbolHeightRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<HeightInfo>> {
        const queryParameters: any = {};
     ...
     */
    async getSymbolNodeByMainPublicKeyRaw(requestParameters: GetSymbolNodeByMainPublicKeyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Node>> {
     ...
     * Returns information about the Symbol node with matching main public key.
     */
    async getSymbolNodeByMainPublicKey(requestParameters: GetSymbolNodeByMainPublicKeyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Node> {
     ...
     */
    async getSymbolNodeByNodePublicKeyRaw(requestParameters: GetSymbolNodeByNodePublicKeyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Node>> {
     ...
     * Returns information about the Symbol node with matching node public key.
     */
    async getSymbolNodeByNodePublicKey(requestParameters: GetSymbolNodeByNodePublicKeyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Node> {
     ...
     */
    async getSymbolNodesCountRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<TimeSeriesNodesCountInner>>> {
        const queryParameters: any = {};
     ...
     * Returns Symbol node count time series.
     */
    async getSymbolNodesCount(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<TimeSeriesNodesCountInner>> {
     ...
     */
    async getSymbolPeerNodesRaw(requestParameters: GetSymbolPeerNodesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Node>>> {
        const queryParameters: any = {};
     ...
     * Returns the list of known Peer Symbol nodes.
     */
    async getSymbolPeerNodes(requestParameters: GetSymbolPeerNodesRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Node>> {
...
export type GetSymbolPeerNodesOrderEnum = typeof GetSymbolPeerNodesOrderEnum[keyof typeof GetSymbolPeerNodesOrderEnum];
